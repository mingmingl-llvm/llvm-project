...
; RUN:   --export-dynamic-symbol=_ZTI7Derived 2>&1 | FileCheck %s --implicit-check-not='single-impl: devirtualized a call to _ZN8DerivedN5printEv'
...
define hidden noundef i32 @main() #6 !dbg !31 {
entry:

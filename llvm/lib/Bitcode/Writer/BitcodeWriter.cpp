...
public:
  ...
  IndexBitcodeWriter(BitstreamWriter &Stream, StringTableBuilder &StrtabBuilder,
      ...
      : BitcodeWriterBase(Stream, StrtabBuilder), Index(Index),
        ...
        ModuleToDeclarationSummaries(ModuleToDeclarationSummaries) {
...
void IndexBitcodeWriter::writeCombinedGlobalValueSummary() {
  ...
  forEachSummary([&](GVInfo I, bool IsAliasee) {
    ...
    auto shouldImportFuncAsDec = [&](FunctionSummary* FS) -> bool {
      if (!HasDeclarationMap)  return false;
    ...
    NameVals.push_back(getEncodedGVSummaryFlags(FS->flags(), shouldImportFuncAsDec(FS)));
    NameVals.push_back(FS->instCount());
    NameVals.push_back(getEncodedFFlags(FS->fflags()));
...
void llvm::writeIndexToFile(
  ...
  Writer.writeIndex(&Index, ModuleToSummariesForIndex, ModuleToDeclarationSummaries);
  Writer.writeStrtab();
